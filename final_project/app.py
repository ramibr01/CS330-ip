...
#===========================================================================================================
# Allows for modifying table rows by updating each column value based on user input
#===========================================================================================================
@app.route("/edit_table",methods=['GET', 'POST'])
def edit_table():
    if request.method == 'POST':
        oldTitle = request.form.get('title')
        newTitle = request.form.get('newtitle')
        newDirector = request.form.get('director')
        newReleased = request.form.get('released')

        cur.execute("UPDATE MOVIES SET TITLE = '{}', DIRECTOR = '{}', RELEASED = '{}' WHERE TITLE = '{}'".format(newTitle,newDirector,newReleased,oldTitle))
